...
public class MoveState {
    ...
    public final boolean prevImmediateActionState;

    public MoveState(Piece movedPiece,Piece capturedPiece,Pawn previousEPPawn, Pawn promotedPawn, boolean movingPieceHadMoved, boolean castledRookHadMoved, boolean prevImmediateActionState) {
        ...
        this.prevImmediateActionState = prevImmediateActionState;
    }
}
